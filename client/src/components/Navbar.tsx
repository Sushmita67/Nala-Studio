      ...
      >
        <Container className="relative flex h-14 items-center justify-between gap-4 lg:h-16">
          ...
          >
            <div onMouseEnter={openServices} onMouseLeave={scheduleClose}>
              <button
                ...
                className={cn(
                  'font-ui inline-flex items-center gap-1 rounded-full px-3 py-1.5 text-sm font-medium tracking-[-0.01em] text-nala-charcoal/70 transition-all duration-200 hover:text-nala-charcoal',
            ...
            {navItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    'font-ui rounded-full px-3 py-1.5 text-sm font-medium tracking-[-0.01em] transition-colors duration-200',
                    isActive
                      ? 'text-nala-charcoal'
          ...
          >
            <Link
              to="/admin/login"
              className="font-ui hidden items-center gap-1.5 rounded-full px-2.5 py-1.5 text-sm font-medium text-nala-muted transition hover:text-nala-charcoal lg:inline-flex"
            ...
            <Link
              to="/contact"
              className="font-ui hidden items-center gap-1.5 rounded-full border border-nala-charcoal/20 px-3 py-1.5 text-sm font-medium text-nala-charcoal transition hover:border-nala-charcoal/40 hover:bg-nala-mist/60 md:inline-flex"
            >
            ...
            <Link
              to="/book"
              className="font-ui group hidden items-center justify-center gap-1.5 rounded-full bg-nala-charcoal px-3.5 py-1.5 text-sm font-semibold tracking-[-0.01em] text-white transition hover:bg-nala-brown sm:inline-flex"
            >
              Book now
              <ArrowRight
                size={12}
