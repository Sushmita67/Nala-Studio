      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-10">
          <div className="mb-3 flex items-end justify-between gap-4">
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.16em] text-nala-muted">
          ...
          <ol className="mt-4 hidden items-center gap-1 sm:flex" aria-hidden>
            {stepLabels.map((label, i) => (
              <li key={label} className="flex min-w-0 flex-1 flex-col items-center gap-1.5">
                ...
                />
                <span
                  className={`truncate text-sm uppercase tracking-[0.1em] ${
                    i === stepIndex
          ...
          >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mt-2 inline-flex items-center gap-1 text-sm text-nala-muted">
            ...
            {step === 'datetime' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-7 gap-1 text-center text-sm uppercase tracking-wider text-nala-muted">
